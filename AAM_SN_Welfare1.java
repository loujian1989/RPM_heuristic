 ...
 * Revised on 08/06/16
 */
public class AAM_SN_Welfare1 {

    public static void main(String[] args)throws Exception
    {
        long startTime = System.currentTimeMillis();

        Scanner cin=new Scanner(new File("cross1.txt"));
        File writename = new File("AAM_cross1.txt");
        writename.createNewFile();
        BufferedWriter out = new BufferedWriter(new FileWriter(writename));
        int n = 46; //n means the number of players in the game.
