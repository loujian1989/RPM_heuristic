...
public class AAM_SN_Heuristic_Welfare_noIES {

    public static void main(String[] args)throws Exception
    {
        long startTime = System.currentTimeMillis();

        Scanner cin=new Scanner(new File("SN_Scale_Free_1000_n30m4.txt"));
        File writename = new File("AAM_heuristic_SN_Scale_Free_1000_n30m4_noIES_alpha00.txt");
        ...
        for(int iter=1; iter<=num_cases; iter++) {
            ...
            */
            ...
            AAM_SN_Heuristic_noIES TF_H = new AAM_SN_Heuristic_noIES(n, depth, order, value, linked_value, lower, upper);
            //Team_Form_Pranav TF= new Team_Form_Pranav(n, depth, order, value, linked_value);
            ArrayList<Integer> array = TF_H.ARM();



            //AAM_SN TF= new AAM_SN(n, depth, order, value, linked_value1);
