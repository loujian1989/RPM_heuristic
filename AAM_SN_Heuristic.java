 ...
 * It is an implementation with heuristics.
 */
...
public class AAM_SN_Heuristic {
    ...
    AAM_SN_Heuristic (int n, int depth, LinkedList<Integer> order1, ArrayList<ArrayList<Integer>> value1, ArrayList<LinkedList<Integer>> linked_value1, double lower_accept, double upper_reject)
    {
        this.n= n;
        this.depth= depth;
