...
/**
 * Created by loujian on 3/13/16.
 */
public class Utilitarial_Social_Welfare {
    ...
    public static void main(String[] args)throws Exception
    {
        ...
        File writename = new File("ARM_out.txt");
        ...
        for(int iter=1; iter<=num_cases; iter++) {
            ...
            int n = 4; //n means the number of players in the game.
            //int order_num; //means the actual number of players after preprocessing
            int depth = 4;// depth means search depth
