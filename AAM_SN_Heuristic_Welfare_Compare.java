...
public class AAM_SN_Heuristic_Welfare_Compare {

    public static void main(String[] args)throws Exception
    {
        long startTime = System.currentTimeMillis();

        Scanner cin=new Scanner(new File("SN_Scale_Free_1000_n60m3.txt"));
        File writename = new File("AAM_heuristic_compare_SN_Scale_Free_1000_n60m3_alpha30.txt");
        writename.createNewFile();
        BufferedWriter out = new BufferedWriter(new FileWriter(writename));
        int n = 60; //n means the number of players in the game.
        ...
        for(int iter=1; iter<=num_cases; iter++) {
            ...
            */
            ...
            AAM_SN_Heuristic TF= new AAM_SN_Heuristic(n, depth, order, value, linked_value1, 0, 1);
            ArrayList<Integer> array_original= TF.ARM();

            int same_teammate_two_methods= 0;

            for(int i=1; i<=n; i++) //we look at whether two methods can get the same results
            {
                if(array.get(i)==array_original.get(i))
                    same_teammate_two_methods++;
            }
            double same_ratio= (double) same_teammate_two_methods/n;
            total_ratio+= same_ratio;
            ...
            out.write("The same ratio for different methods is" + same_ratio + "\r\n");
            for(int i=1; i<=n; i++)
                out.write(deviate[i]+" ");
            out.write("\r\n");
            out.write("\r\n");
        ...
        out.write("The average same number of teammates is " + total_ratio/num_cases + "\r\n");
