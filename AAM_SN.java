 ...
 * It was designed to deal with regular network.
 */
...
public class AAM_SN {
    ...
    AAM_SN(int n, int depth, LinkedList<Integer> order1, ArrayList<ArrayList<Integer>> value1, ArrayList<LinkedList<Integer>> linked_value1)
    {
        this.n= n;
        this.depth= depth;
